...
path_train = '/oak/rosa/workspace2/tensor/train/tensor/'
path_test = '/oak/rosa/workspace2/tensor/test/tensor/'
path_model = '/oak/rosa/workspace2/tensor/model-pytorch.mat'
path_weight = '/home/lixun/git/nr/data/spweight-mel136.mat'
path_logger = '/oak/rosa/workspace2/tensor/loss.log'
...
gpu_mem_available = 8*1024*1024*1024
